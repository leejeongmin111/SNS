import "../../styles/UserPage/UserProfilemy.scss";
import ProfileIcon from "../UserPage/UserProfileIcon";
...
import Myfollow_Click from "./Userfollow_Click";
...
import Userfollowing_Click from "./Userfollowing_Click";
import Userfollow_Click from "./Userfollow_Click";
...
function Profilemy(props) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        if (res.data.followCnt === null) {
          setFollowCnt(0);
        } else {
          setFollowCnt(res.data.followCnt);
        }
        if (res.data.followingCnt[0].cnt === null) {
          setFollowing(0);
        } else {
  ...
  function Open_follow() {
    temp = 1;
    setFollow_open(<Userfollow_Click></Userfollow_Click>);
    setOpen(true);
  }
  function Open_following() {
    temp = 0;
    setFollow_open(<Userfollowing_Click></Userfollowing_Click>);
    setOpen(true);
  }
      ...
      <div className="My_profile">
        ...
        {(accountName || caption) && !hideAccountName && (
          <div className="My_textContainer">
            <span className="My_accountName">{userId}</span>
